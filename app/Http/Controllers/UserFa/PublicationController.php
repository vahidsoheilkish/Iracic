...
{
    // get group publication or group/major publication and display in view => get
    public function publications(Group $group , Major $major){
        if($major->id != null){
            ...
            return view('user_fa/publications' , compact('publications','group','major'));
        }else{
    ...
    public function publication($id){
        ...
        return view('user_fa/publication_volumes',compact('journal','group','major'));
    }
    ...
    public function article(Article $article){
        ...
        return view('user_fa/publication_article',compact('article','authors','abstract','keywords','structs','resource','resource_cite','pdf_file','related_articles'));
    }
