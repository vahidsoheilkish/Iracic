...
@section('styles')
    <style>
        ...
        #article_info_container{text-align: right;}
    </style>
@endsection
@section('content')
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-12">
                    ...
                    <h3 class="text-muted">{{ $title->l2 }}</h3>
        ...
        <div class="row container-publication-conference">
            <div class="col-12 col-md-4 journal-content">
                <ul class="journal-content-list">
                    <li>   مکان برگزاری کنفرانس: {{ $conference->place }} </li>
                    <li>تاریخ برگزاری کنفرانس:</li>
                    <li> {{ $conference->printISSN }} : Print ISSN </li>
                </ul>
            </div>
            ...
            <div class="co-12 col-md-4 journal-content">
                <ul class="journal-content-list text-center">
                    <li>آخرین دوره</li>
                    <li>پربازدیدترین مقالات</li>
                    <li>پژوهشگران برتر</li>
                </ul>
            </div>
        </div>
    </div>
    <div class="container-fluid wow slideInLeft" data-wow-duration="3s">
        <div class="row justify-content-center mt-5">
            <ul class="breadcrumb-2">
                <li><a href="#" class="pr-1">دوره , شماره<i class="fa fa-chevron-left pr-3 pt-1"></i></a></li>
                <li><a href="#" class="pr-1"> دوره 51<i class="fa fa-chevron-left pr-3 pt-1"></i> </a></li>
                <li><a href="#"  class="pr-1"> تابستان , بهار 2018<i class="fa fa-chevron-left pr-3 pt-1"></i></a></li>
                <li><a href="#" class="pr-1">صفحه 229-463</a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid section-2">
        <div class="row">
            ...
            <div class="col-12 col-md-7 col-lg-9 article-sidebar" style="direction:rtl;">
                    ...
                    if(data.length !== 0){
                        $.each(data, (key,item) => {
                            article_info_container.append('<li>' +
                                '<a href="/fa/conference/article/page/'+ item._id +'" target="_blank">'+ item._id +'</a>' +
                                '</li>');
                        });
                    }else{
                        swal("No article");
                ...
                success(data){
                    ...
                    $.each(data,(key,article)=>{
                        ...
                        $("#article_info_container").append('<li class="journals-section">\n' +
                            '                            <a href="/fa/conference/article/page/'+article.id+'" target="_blank">\n' +
