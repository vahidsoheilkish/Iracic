...
@section('styles')
    <style>
        ...
        #authors label {font-size:12px;margin:16px 0;float: left;clear: left;}
        ...
        .steps{background-color:none;color:#222;border:2px solid #222;}
        .one_author{direction:ltr; width:42%; float:right; clear:left; border-bottom:2px solid #ccc;border-left:1px solid tomato;padding:15px;}
        ...
        .breadcrumb-pagination {width:100%;border-bottom:1px solid #E1E6EB;text-align:center;margin:40px;float:left;color:#B3B7C1;}
        ...
        .step_wrapper{border:1px solid tomato;padding:8px 0; border-radius:10px;}
        .step_wrapper:hover{cursor: pointer; transition: .3s; animation-name: slide-top; animation-duration: 1s; background-color: #e1e1e1}
    </style>
@endsection
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="text-align: left; padding:30px; margin:20px 10px auto !important; border-radius:10px; box-shadow:0 0 5px #588bff">
                ...
                <form action="{{route('conference.article.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="article_form1" novalidate>
                    <div id="article_submit1" class="col-xl-11 col-lg-11 col-md-11 col-sm-12 col-xs-12">
                        <input type="hidden" id="_token" name="_token" value="{{ csrf_token() }}"/>
                        <input type="hidden" id="conference_id" name="conference_id" value="{{$conference->id}}"/>
                        <div class="form-group">
                            <input type="hidden" name="group_id" id="group_id" class="form-control ltr" value="{{$conference->group_id}}" readonly required/>
                            <input type="hidden" name="major_id" id="major_id" class="form-control ltr" value="{{$conference->major_id}}" readonly required/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group" id="authors">
                            ...
                            <div class="authors_form" id="authors_form_1">
                                <p class="tar author_list" style="">Author 1</p>
                        ...
                        <hr style="clear: both; position: relative; top:12px;"/>
                        <div class="form-group tal" style="margin:20px 0; clear: both;">
                            <input type="button" id="btn_form1" value="Next step" class="btn btn-success" style="width:30%;"/>
                        </div>
                    </div> <!-- end of form1 -->
                    <div id="article_submit2" class="col-xl-11 col-lg-11 col-md-11 col-sm-12 col-xs-12">
                        ...
                        <div class="row form-group">
                            <div class="col-sm-6">
                                ...
                                <input type="text" name="accepted_date" id="accepted_date" class="form-control" placeholder="Accepted date" readonly required value="{{ old('accepted_date') }}"/>
                            </div>
                            <div class="col-sm-6">
                                <label for="receieved_date" style="margin:6px;"><span class="star">*</span>Receieved date</label>
                                <input type="text" name="receieved_date" id="receieved_date" class="form-control" placeholder="Receieved date" readonly required value="{{ old('receieved_date') }}"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row form-group ltr">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="number" min="1" max="1000" name="page_from" id="page_from" class="form-control-sm" placeholder="" required value="{{ old('page_from') }}" style="color:#222; background-color: #f6f6f6;"/>
                            </div>
                            <div class="col-sm-4">
                                <label for="page_to" style="margin:6px;"><span class="star">*</span>End page</label>
                                <input type="number" min="1" max="1000" name="page_to" id="page_to"  class="form-control-sm" placeholder="" required value="{{ old('page_to') }}" style="color:#222; background-color: #f6f6f6;"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row form-group ltr">
                            <div class="col-sm-3">
                                <label for="press" class="bg bg-warning" style="padding:4px; border-radius:2px; color:#222;">Registration in the press</label>
                            </div>
                            <div class="col-sm-2">
                    ...
                    <div id="article_submit3" class="col-xl-11 col-lg-11 col-md-11 col-sm-12 col-xs-12">
                        <div class="form-group">
    ...
    <input type="hidden" id="conference_slug" value="{{$conference->lang}}"/>
@endsection
@section('script')
    <script type="text/javascript">
        $(document).ready(function(){
            $("*:not('#menu_list')").removeClass('active');
            $("#menu_list").css("font-size","12px");
            $("#menu_list").html("Conference list > submit article");
            $("#struct_images").val(0);
        ...
        {{--e.preventDefault();--}}
        {{--$.ajax({--}}
        {{--url: '{{ route('conference.article.upload.file') }}' ,--}}
        {{--method: "POST",--}}
        {{--dataType: 'json',--}}
        ...
        function addAuthor(){
            ...
            $("#authors_form_" + nextIndex).append('<p class="tar author_list">Author '+nextIndex+'</p>' +
                '                            <div class="one_author">' +
                '                                       <div class="row">\n' +
                '                                            <div class="col-sm-5">\n' +
                '                                                <label for="author_name_1"><span class="star">*</span>Author name</label>\n' +
