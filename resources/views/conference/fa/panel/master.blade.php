...
<nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
    <ul class="navbar-nav px-3">
        <li class="nav-item text-nowrap">
            <form action="{{ route('conference.notice.logout.fa') }}" method="post" style="display: inline;">
                @csrf
                <input type="submit" value="خروج از حساب کاربری" class="btn btn-danger btn-sm"/>
            </form>
        </li>
    </ul>
    <a class="navbar-brand col-sm-3 col-md-2 mr-0 tac" href="/fa">
...
<div class="container-fluid">
    <div class="row">
        <nav class="col-md-2 d-none d-md-block sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column tac">
                    <li class="nav-item">
                        <a id="menu_dashboard" class="nav-link active" href="{{route('conference.notice.dashboard.fa')}}">
                    ...
                    @if(!isset($user->conference->_id))
                        <li class="nav-item">
                            <a id="menu_journal_register" class="nav-link active" href="{{ route('conference.notice.create.fa') }}">
                    ...
                    @endif
                    <li class="nav-item">
                        <a id="menu_volume_register" class="nav-link active" href="{{ route('conference.notice.create.volume.fa' , ['conference'=>$user->conference]) }}">
                            <span data-feather="file"></span>
                            ثبت دوره
                        </a>
                    </li>
                    <li class="nav-item">
                        <a id="menu_list" class="nav-link active" href="{{ route('conference.notice.volumes.list.fa')  }}">
                ...
                <ul class="nav flex-column mb-2 tac">
                    <li class="nav-item">
                        <a id="menu_notification" class="nav-link active" href="{{ route('conference.notice.notifications.fa') }}">
                    ...
                    <li class="nav-item">
                        <a id="menu_change_password" class="nav-link active" href="{{ route('conference.notice.change.pass.form.fa') }}">
                            <span data-feather="file-text"></span>
                            تغییر رمز عبور
                        </a>
                    </li>
        ...
        <main role="main" class="col-md-9 mr-sm-auto col-lg-10 px-4" style="margin-top:40px; overflow-x:hidden;">
            @yield('content')
        </main>
    </div>
</div>
