...
@section('content')
        <div class="row rtl">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <form action="{{route('conference.article.store.fa')}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="" novalidate>
                    <div id="article_submit1" class="col-xl-11 col-lg-11 col-md-11 col-sm-12 col-xs-12">
                        ...
                        <input type="hidden" id="volume_id" name="volume_id" value="{{$volume}}"/>
