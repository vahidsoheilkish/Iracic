                ...
                <div class="page-body">
                    <div class="row rtl">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form action="{{route('admin.conference.article.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="" novalidate>
                                <div id="article_submit1" class="col-xl-11 col-lg-11 col-md-11 col-sm-12 col-xs-12">
                                    <input type="hidden" id="_token" name="_token" value="{{ csrf_token() }}"/>
                                    <input type="hidden" id="volume_id" name="volume_id" value="{{$volume->id}}"/>
                                    <div class="form-group">
                                        <input type="hidden" name="group_id" id="group_id" class="form-control ltr" value="{{$group}}" readonly required/>
                                        <input type="hidden" name="major_id" id="major_id" class="form-control ltr" value="{{$major}}" readonly required/>
                                        <input type="hidden" name="conference_lang" id="conference_lang" class="form-control ltr" value="{{$volume->conference->lang}}" readonly required/>
                                    </div>
                                </div>
                                <div class="container border p-5">
                                    ...
                                    <div class="form-group">
                                        <div id="resource_counter" class="tac alert alert-info">
                                            ...
                                            <span class="" id="col2" style="font-size: 24px; vertical-align: 1px;"><span id="resource_number"></span></span>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="pt-1">
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input type="radio" class="mr-2" id="customRadioYes_1" name="author_manager_0" value="1">
                                                            <label class="custom-control-label mr-2" for="customRadioYes_1">بلی</label>
                                                        </div>
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input type="radio" class="mr-2" id="customRadioNo_1" name="author_manager_0" value="0">
                                                            <label class="custom-control-label mr-2" for="customRadioNo_1">خیر</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-lg-9">
                                                <div class="row">
                                                    <div class="col-12 col-lg-5">
                                                        <div class="form-group row">
                                                            <label for="receieved_date" class="col-12 col-lg-5 col-form-label"><i class="fa fa-asterisk text-danger star"></i>تاریخ دریافت مقاله:</label>
                                                    ...
                                                    <div class="col-12 col-lg-7">
                                                        <div class="form-group row">
                                                            <label for="accepted_date" class="col-12 col-lg-7 col-form-label"><i class="fa fa-asterisk text-danger star"></i>تاریخ پذیرش در مجله/ کنفرانس:</label>
                                    ...
                                    <div class="row pt-4">
                                        <div class="col-12 col-lg-3">
                                            <div class="row">
                                                ...
                                                <div class="pt-1">
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" class="mr-2" id="customRadio3" name="press" value="1">
                                                        <label class="custom-control-label mr-2" for="customRadio3">بلی</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" class="mr-2" id="customRadio4" name="press" value="0">
                                                        <label class="custom-control-label mr-2" for="customRadio4">خیر</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#menu_list").html("لیست کنفرانس ها > ثبت مقاله");
            $("#struct_images").val(0);
        ...
        function addAuthor(){
            ...
            $("#authors_form_" + nextIndex).append(' <button class="btn authors">نویسنده '+digitToFarsi(nextIndex)+'</button>\n' +
                ...
                '                                        <div class="pt-1">\n' +
                '                                            <div class="custom-control custom-radio custom-control-inline">\n' +
                '                                                <input type="radio" class="mr-2" id="customRadioYes_'+nextIndex+'" name="author_manager_'+(nextIndex-1)+'" value="1">\n' +
                '                                                <label class="custom-control-label mr-2" for="customRadioYes_'+nextIndex+'">بلی</label>\n' +
                '                                            </div>\n' +
                '                                            <div class="custom-control custom-radio custom-control-inline">\n' +
                '                                                <input type="radio" class="mr-2" id="customRadioNo_'+nextIndex+'" name="author_manager_'+(nextIndex-1)+'" value="0">\n' +
                '                                                <label class="custom-control-label mr-2" for="customRadioNo_'+nextIndex+'">خیر</label>\n' +
                '                                            </div>\n' +
                '                                        </div>\n' +
                '                                    </div>');
        }
