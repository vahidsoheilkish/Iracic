                ...
                <div class="page-body">
                    <div class="row rtl">
                        ...
                        <div class="col-sm-11" style="margin:0 auto;">
                            ...
                            @csrf
                            <form action="{{ route('admin.publication.store.publication') }}" enctype="multipart/form-data" method="post" class="form-horizontal" id="" novalidate>
                                <input type="hidden" name="publication_user_id" value="{{$user}}" />
                                @csrf
