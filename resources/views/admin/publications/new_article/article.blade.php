        ...
        <div class="main-body">
            <div class="page-wrapper">
                <div class="page-body">
                    ...
                    <form action="{{ route('admin.publication.article.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal rtl" id="" novalidate>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="pt-1">
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" class="" id="customRadioYes_1" name="author_manager_0" value="1">
                                                    <label class="custom-control-label" for="customRadioYes_1"  style="margin:3px;">بلی</label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" class="" id="customRadioNo_1" name="author_manager_0" value="0">
                                                    <label class="custom-control-label" for="customRadioNo_1"  style="margin:3px;">خیر</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row pt-4">
                                <div class="col-12 col-lg-3">
                                    <div class="row">
                                        ...
                                        <div class="pt-1">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" class="" id="customRadio3" name="press" value="1" style="margin:3px;">
                                                <label class="custom-control-label" for="customRadio3">بلی</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" class="" id="customRadio4" name="press" value="0" style="margin:3px;">
    ...
    <script type="text/javascript">
        ...
        function addAuthor(){
            ...
            $("#authors_form_" + nextIndex).append(' <button class="btn authors">نویسنده '+digitToFarsi(nextIndex)+'</button>\n' +
                ...
                '                                        <div class="pt-1">\n' +
                '                                            <div class="custom-control custom-radio custom-control-inline">\n' +
                '                                                <input type="radio" class="" id="customRadioYes_'+nextIndex+'" name="author_manager_'+(nextIndex-1)+'" value="1" >\n' +
                '                                                <label class="custom-control-label" style="margin:3px;" for="customRadioYes_'+nextIndex+'">بلی</label>\n' +
                '                                            </div>\n' +
                '                                            <div class="custom-control custom-radio custom-control-inline">\n' +
                '                                                <input type="radio" class="" id="customRadioNo_'+nextIndex+'" name="author_manager_'+(nextIndex-1)+'" value="0" >\n' +
                '                                                <label class="custom-control-label" style="margin:3px;" for="customRadioNo_'+nextIndex+'">خیر</label >\n' +
                '                                            </div>\n' +
                '                                        </div>\n' +
                '                                    </div>');
        }
