                    ...
                    <div class="row" style="margin:20px 0;">
                        <div class="col-sm-12">
                            <div class="form-group-lg">
                                <h2 class="tar">ویرایش منو</h2>
                            </div><hr/>
                            <form action="{{ route('admin.menu.update' , ['menu'=>$menu]) }}" method="post" enctype="multipart/form-data" style="direction:rtl;">
                                @csrf
                                {{ method_field('patch') }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="link" name="link" class="form-control tal ltr" value="{{ $menu->link }}" />
                                </div>

                                @if($menu->img)
                                    <div class="form-group tac">
                                        <h4 class="alert alert-success">تصویر قبلی</h4>
                                        <img src="/upload/menu/{{$menu->img}}" style="width:120px; border:1px solid #222222; padding:4px; border-radius:6px;" />
                                    </div>
                                @else
                                    <h4 class="alert alert-danger">تصویری برای این منو وجود ندارد</h4>
                                @endif
