                    ...
                    <div class="row" style="margin:20px 0;">
                        <div class="col-sm-12">
                            <div class="form-group-lg">
                                <h2 class="tar">زیر منوی جدید</h2>
                            </div><hr/>
                            <form action="{{ route('admin.submenu.store') }}" method="post" enctype="multipart/form-data" style="direction:rtl;">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="menu_id" name="menu_id" class="form-control" >
                                        @foreach($menus as $menu)
                                            ...
                                            <option value="{{ $menu->id }}">{{ $name->fa }}  ****  {{$name->en }}</option>
                                        @endforeach
                                    </select>
                                </div>
