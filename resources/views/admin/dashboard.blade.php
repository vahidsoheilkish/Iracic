                                ...
                                <div class="card bg-c-yellow update-card">
                                    <div class="card-block">
                                        <div class="row align-items-end">
                                            ...
                                            <div class="col-9">
                                                <h4 class="text-white">{{ $author_count }}</h4>
                                                <h6 class="text-white m-b-0">تعداد نویسندگان</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                        <p class="text-white m-b-0" style="text-align:center;"><i class="feather icon-clock text-white f-14 m-r-10" style="vertical-align: middle;"></i>update : 2:15 am</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-c-green update-card">
                                    <div class="card-block">
                                        <div class="row align-items-end">
                                            ...
                                            <div class="col-9">
                                                <h4 class="text-white">{{ $user_count }}</h4>
                                                <h6 class="text-white m-b-0">تعداد کاربران</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                ...
                                <div class="card bg-c-pink update-card">
                                    <div class="card-block">
                                        <div class="row align-items-end">
                                            ...
                                            <div class="col-9">
                                                <h4 class="text-white">{{ $article_conference_count }}</h4>
                                                <h6 class="text-white m-b-0">تعداد مقالات کنفرانس</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                ...
                                <div class="card bg-c-lite-green update-card">
                                    <div class="card-block">
                                        <div class="row align-items-end">
                                            ...
                                            <div class="col-9">
                                                <h4 class="text-white">{{ $article_publication_count }}</h4>
                                                <h6 class="text-white m-b-0">تعداد مقالات نشریه</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                    ...
                                    <div class="card-block">
                                        <div class="row m-b-25">
                                            <div class="col-auto p-r-0">
                                                <div class="u-img">
                                                    <img src="/img/admin/breadcrumb-bg.jpg" alt="user image" class="img-radius cover-img">
                                                    <img src="/img/admin/avatar-2.jpg" alt="user image" class="img-radius profile-img">
                                                </div>
                                            </div>
                                            <div class="col">
                                            ...
                                            <div class="card-block">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <h6 class="text-muted f-w-400"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="204a454e5960474d41494c0e434f4d">[email&#160;protected]</a></h6>
                                                    </div>
                                                    <div class="col-sm-6">
