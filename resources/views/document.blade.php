...
<div style="width:100%; display:flex; border-top:1px solid #000; border-bottom:4px solid #000; margin:50px auto; ">
    <div style="width:10%; margin:10px 0 0 0; float:left; border-radius:2px;">
        <img src="{{public_path('img/pdf/logo.png')}}" style="height:150px;"/>
    </div>
    <div style="width:75%; float:left; clear:right; text-align:center; background-color:#a9a434;margin:0 10px;">
        <p style="font-size:9px; margin:0; padding:4px">Contents lists available at ScienceDirect</p>
        <h4 style="font-weight:bolder; margin:6px; padding:4px;">{{ $article->title }}</h4>
        <p style="font-size:9px; padding:2px; margin:0;">journal homepage:
            <a href="www.elsevier.com/locate/yjbin" style="font-size:9px;">www.elsevier.com/locate/yjbin</a>
        </p>
    </div>
    <div style="width:10%; float:left; margin:10px 0 0 20px; border-radius:2px;">
