            ...
            <div class="col-12 col-lg-8 order-sm-first order-lg-first">
                ...
                <div class="card card-register mt-5">
                    <div class="card-header" style="background-color: #e4606d">
                        <h5 class="text-center text-white">User Register</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('publication.register') }}" method="post" class="form-horizontal" id="" novalidate>
                            @csrf
                            <div class="form-row">
                                <div class="form-group col-6">
                                    <label for="name"><i class="text-danger star_field">*</i>Journal Name :</label>
                                ...
                                <div class="form-group col-6">
                                    <label for="website"><i class="text-danger star_field">*</i>Journal Website :</label>
                                ...
                                <div class="form-group col-6">
                                    <label for="email"><i class="text-danger star_field">*</i>Journal Email Address :</label>
                            ...
                            <div class="form-row">
                                <div class="form-group col-6">
                                    <label for="password"><i class="text-danger star_field">*</i>Password :</label>
                                    <input type="password" name="password" id="password" class="form-control" placeholder="Enter password at least 6 character" required value=""/>
                                </div>
                                <div class="form-group col-6">
                                    <label for="password"><i class="text-danger star_field">*</i>Repassword :</label>
                                    <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" placeholder="Enter confirm password" required value=""/>
                                </div>
                                <div class="form-group col-6">
                            ...
                            <button type="submit" class="btn btn-sm mx-auto d-block mt-3 text-white rounded-0 font-weight-bold"  style="background-color: #e4606d">Register</button>
                        </form>
                     </div>
                </div>
            </div>
