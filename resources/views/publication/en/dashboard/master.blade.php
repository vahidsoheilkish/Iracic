...
<body>
    ...
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
        ...
        <ul class="navbar-nav px-3">
            <li class="nav-item text-nowrap">
                <form action="{{ route('publication.logout') }}" method="post" style="display: inline;">
                    @csrf
    ...
    <div class="container-fluid">
        <div class="row">
            <nav class="col-md-2 d-none d-md-block bg-light sidebar">
                <div class="sidebar-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a id="menu_dashboard" class="nav-link active" href="{{route('publication.dashboard')}}">
                                <span data-feather="home"></span>
                                Dashboard <span class="sr-only">(current)</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a id="menu_journal_register" class="nav-link active" href="{{ route('publication.create') }}">
                        ...
                        <li class="nav-item">
                            <a id="menu_tree_list" class="nav-link active" href="{{ route('publication.tree.list') }}">
                                <span data-feather="file"></span>
                    ...
                    <ul class="nav flex-column mb-2">
                        <li class="nav-item">
                            <a id="menu_notification" class="nav-link active" href="{{ route('publication.notifications') }}">
                        ...
                        <li class="nav-item">
                            <a id="menu_change_password" class="nav-link active" href="{{ route('publication.change.password.form') }}">
                                <span data-feather="file-text"></span>
                                Change password
                            </a>
                        </li>
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4" style="">
                @yield('content')
            </main>
        </div>
    </div>
